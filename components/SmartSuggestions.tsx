...
export default function SmartSuggestions({
  ...
  return (
    <div className="card p-6">
      ...
      {/* Info message when no suggestions */}
      {(!pathsData?.suggestions || pathsData.suggestions.length === 0) && (
        <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-2 border-blue-200 dark:border-blue-700">
          <div className="text-center mb-4">
            ...
            <h3 className="text-xl font-bold text-blue-900 dark:text-blue-100 mb-2">
              Wykorzystaj dodatkowe oszczędności emerytalne
            </h3>
            <p className="text-sm text-blue-800 dark:text-blue-200">
              Poniżej znajdziesz szczegółową analizę PPK, IKE i IKZE, która
              pokazuje ile musisz odkładać miesięcznie, aby uzupełnić lukę do
              swojego celu.
            </p>
          </div>
        </div>
